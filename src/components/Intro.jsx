...
function Intro() {
  return (
    <div className="wrapper intro-container text-center">
      <div className="intro-logo inline-flex rounded-full justify-center bg-blue-200 h-20 w-20 text-4xl text-blue-600 ">
        <RiShoppingBag3Line />
      </div>
      ...
      <p className="line-clamp-2 text-xl text-gray-600">
